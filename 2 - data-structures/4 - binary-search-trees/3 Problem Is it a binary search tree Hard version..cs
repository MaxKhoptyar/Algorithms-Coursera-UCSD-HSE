...
namespace StructureToolbox
{
    class Program
    {
        ...
        {
            return IsBstUtilLeft(element.LeftEl, min, element.Data) && IsBstUtilRight(element.RightEl, element.Data, max);
        }

        public static bool IsBstUtilLeft(TreeElement element, int min, int max)
        {
            if (element == null)
            {
                return true;
        ...
        public static bool IsBstUtilRight(TreeElement element, int min, int max)
        {
            if (element == null)
            {
                return true;
